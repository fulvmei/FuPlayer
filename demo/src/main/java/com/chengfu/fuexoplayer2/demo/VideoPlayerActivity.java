...
//        AdsMediaSource adsMediaSource = new AdsMediaSource(null,null,null,null);
//        AdsMediaSource adsMediaSource = new AdsMediaSource(getMediaSource(Uri.parse(path1)), null, null, null);
