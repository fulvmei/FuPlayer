...
public class PlayerNotificationManager {
    ...
    public final void setPlayer(@Nullable FuPlayer player) {
        ...
        if (player != null) {
            ...
            if (lastPlaybackState != FuPlayer.STATE_IDLE) {
     ...
     */
    protected Notification createNotification(FuPlayer player, @Nullable Bitmap largeIcon) {
    ...
    private class PlayerListener implements FuPlayer.EventListener {
        ...
        public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
            if ((wasPlayWhenReady != playWhenReady && playbackState != FuPlayer.STATE_IDLE)
        ...
        public void onTimelineChanged(Timeline timeline, @Nullable Object manifest, int reason) {
            if (player == null || player.getPlaybackState() == FuPlayer.STATE_IDLE) {
                return;
            }
            startOrUpdateNotification();
        }
