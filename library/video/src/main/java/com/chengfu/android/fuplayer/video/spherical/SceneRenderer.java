 ...
 */
package com.chengfu.android.fuplayer.video.spherical;
...
import static com.chengfu.android.fuplayer.video.spherical.GlUtil.checkGlError;
...
/*package*/ class SceneRenderer implements VideoFrameMetadataListener, CameraMotionListener {
    ...
    private volatile @C.StreamType
    int defaultStereoMode;
    private @C.StreamType
    int lastStereoMode;
    private @Nullable
     ...
     * @param eyeType              An {@link ProjectionRenderer.EyeType} value
     */
