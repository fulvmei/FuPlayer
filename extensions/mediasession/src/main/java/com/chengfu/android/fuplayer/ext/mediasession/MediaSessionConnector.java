package com.chengfu.android.fuplayer.ext.mediasession;
...
/**
 * Connects a {@link MediaSessionCompat} to a {@link FuPlayer}.
 *
...
public final class MediaSessionConnector {
    ...
    public interface QueueNavigator extends CommandReceiver {
         ...
         * @return The bitmask of the supported media actions.
         */
        long getSupportedQueueNavigatorActions(FuPlayer player);
         ...
         * @param player The player connected to the media session.
         */
        void onTimelineChanged(FuPlayer player);
         ...
         * @param player The player connected to the media session.
         */
        void onCurrentWindowIndexChanged(FuPlayer player);
         ...
         */
        long getActiveQueueItemId(@Nullable FuPlayer player);
         ...
         *                          changes to the player.
         */
        void onSkipToPrevious(FuPlayer player, ControlDispatcher controlDispatcher);
         ...
         *                          changes to the player.
         */
        void onSkipToQueueItem(FuPlayer player, ControlDispatcher controlDispatcher, long id);
         ...
         *                          changes to the player.
         */
        void onSkipToNext(FuPlayer player, ControlDispatcher controlDispatcher);
    }
    ...
    public interface QueueEditor extends CommandReceiver {
         ...
         */
        void onAddQueueItem(FuPlayer player, MediaDescriptionCompat description);

        /**
         * See {@link MediaSessionCompat.Callback#onAddQueueItem(MediaDescriptionCompat description, int
         * index)}.
         */
        void onAddQueueItem(FuPlayer player, MediaDescriptionCompat description, int index);

        /**
         * See {@link MediaSessionCompat.Callback#onRemoveQueueItem(MediaDescriptionCompat
         * description)}.
         */
        void onRemoveQueueItem(FuPlayer player, MediaDescriptionCompat description);
    }
    ...
    public interface RatingCallback extends CommandReceiver {
         ...
         */
        void onSetRating(FuPlayer player, RatingCompat rating);

        /**
         * See {@link MediaSessionCompat.Callback#onSetRating(RatingCompat, Bundle)}.
         */
        void onSetRating(FuPlayer player, RatingCompat rating, Bundle extras);
    }
    ...
    public interface MediaButtonEventHandler {
         ...
         *
         * @param player            The {@link FuPlayer}.
         * @param controlDispatcher A {@link ControlDispatcher} that should be used for dispatching
         *                          changes to the player.
        ...
        boolean onMediaButtonEvent(
                FuPlayer player, ControlDispatcher controlDispatcher, Intent mediaButtonEvent);
    }
    ...
    public interface CustomActionProvider {
         ...
         */
        void onCustomAction(
                FuPlayer player, ControlDispatcher controlDispatcher, String action, Bundle extras);
         ...
         */
        PlaybackStateCompat.CustomAction getCustomAction(FuPlayer player);
    }
    ...
    public interface MediaMetadataProvider {
         ...
         */
        MediaMetadataCompat getMetadata(FuPlayer player);
    }
     ...
     * {@link MediaMetadataProvider#getMetadata(FuPlayer)}.
     */
     ...
     * QueueNavigator#onTimelineChanged(FuPlayer)}.
     *
    ...
    private long buildPlaybackActions(FuPlayer player) {
    ...
    public static final class DefaultMediaMetadataProvider implements MediaMetadataProvider {
        ...
        @Override
        public MediaMetadataCompat getMetadata(FuPlayer player) {
    ...
    private class ComponentListener extends MediaSessionCompat.Callback
        ...
        @Override
        public void onRepeatModeChanged(@FuPlayer.RepeatMode int repeatMode) {
        ...
        @Override
        public void onPositionDiscontinuity(@FuPlayer.DiscontinuityReason int reason) {
